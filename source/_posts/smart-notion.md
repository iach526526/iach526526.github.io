...
最近事情蠻多的，但都不是什麼急事，當我沒有很確定要做什麼就會想一直拖，連帶讓我的累累病發作，做什麼都沒勁，為了改善這個問題我決定改造我的 notion 代辦事項。
<!-- more -->
...
![alt text](https://img.iach.cc/general/smart-notion/Integrations.webp)


回到 notion 在剛剛授權的資料庫裡面選一個你要操作的 page 關聯剛剛創建的服務。
點選右上角三個點> connect to >找到剛剛創建的服務點它一下確定

![alt text](https://img.iach.cc/general/smart-notion/connect.webp)
...
![copy-db-id](https://img.iach.cc/general/smart-notion/dbid.webp)
...
![alt text](https://img.iach.cc/general/smart-notion/githubenv.webp)

可以在 repo 的 action 手動執行看看，結果如下圖。會自動從把優先順序為今日重點的條目清掉並從情境為 random 的條目隨機選一個做為今日重點就是成功了。

![test auto work](https://img.iach.cc/general/smart-notion/test.webp)

![gif demo](https://img.iach.cc/general/smart-notion/demo.gif)

[notion 官方文檔](https://developers.notion.com/docs/create-a-notion-integration)

就是這樣啦，希望大家的事情都可以如期做完。拖延症和累累病退散

[<img src="https://img.iach.cc/general/smart-notion/minoto_and_hinoa_by_mcdobo_degkfuv-fullview.webp" alt="drawing" style="width:600px;"/>](https://www.deviantart.com/mcdobo/art/Minoto-and-Hinoa-874353991)
